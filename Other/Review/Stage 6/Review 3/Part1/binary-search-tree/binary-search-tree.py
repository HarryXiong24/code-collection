...
class BinarySearchTree:
    ...
    def deleteNode(self, value: float) -> bool:
        ...
        def recursion(node: TreeNode, parent: TreeNode) -> bool:
            if not node:
                return False
            ...
            if value < node.val:
                ...
                if not node.left or not node.right:
                    ...
                    cur_min_node = node.right
                    parent_node = node

                    while cur_min_node.left:
                        parent_node = cur_min_node
                        cur_min_node = cur_min_node.left

                    node.val = cur_min_node.val

                    if parent_node.left == cur_min_node:
                        parent_node.left = cur_min_node.right
                    else:
                        parent_node.right = cur_min_node.right
