(Function.prototype as any).myCall = function (this: any, context: any, ...args: any[]) {
  // avoid call Function.prototype.myCall() directly
...
// 测试调用
const res = (func as any).myCall(myCallObj, 5, 4); // 输出: 10
console.log(res);
